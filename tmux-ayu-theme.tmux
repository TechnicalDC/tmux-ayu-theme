...
set "window-status-current-format" "#[fg=$ayu_black,bg=$ayu_visual_grey,nobold,nounderscore,noitalics]#[fg=$ayu_white,bg=$ayu_visual_grey,nobold] #I  #W #[fg=$ayu_visual_grey,bg=$ayu_black,nobold,nounderscore,noitalics]"
